...
public class ModRecipes {
    ...
    public static final RegistryObject<RecipeSerializer<FermentingBarrelRecipe>> FERMENTING_BARREL_SERIALIZER = SERIALIZERS.register("fermenting_barrel", () -> FermentingBarrelRecipe.Serializer.INSTANCE);
