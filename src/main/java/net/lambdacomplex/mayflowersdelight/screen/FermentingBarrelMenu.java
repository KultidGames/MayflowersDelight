...
public class FermentingBarrelMenu extends AbstractContainerMenu {
    ...
    public FermentingBarrelMenu(int id, Inventory inv, BlockEntity entity, ContainerData data){
        ...
        checkContainerSize(inv, 5); //TODO CHANGE ME W SLOT #
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(handler -> {
            this.addSlot(new SlotItemHandler(handler, 0, 27,38));
            this.addSlot(new SlotItemHandler(handler, 1, 63, 38));
            this.addSlot(new SlotItemHandler(handler, 2, 99, 38));
            this.addSlot(new SlotItemHandler(handler, 3, 135, 38));
            this.addSlot(new SlotItemHandler(handler, 4, 135, 61));
        });
    ...
    private static final int TE_INVENTORY_SLOT_COUNT = 5;  // TODO must be the number of slots you have!
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), player, ModBlocks.FERMENTING_BARREL.get());
    }
